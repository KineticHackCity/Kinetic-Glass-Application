...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      <a class="brand" href="#">Kinetic Glass</a>
    </div>
  </div>
</div>
    ...
    <div style="margin-top: 5px;">
      ...
      <div class="span12">
        <div class="alert alert-info">
          ...
          You haven't added any items to your Kinetic timeline yet. Use the controls
  ...
  <div class="row">
    <div class="span4">
      ...
      <form method="post">
        ...
        <textarea name="message" class="span4">Graphs</textarea><br/>
